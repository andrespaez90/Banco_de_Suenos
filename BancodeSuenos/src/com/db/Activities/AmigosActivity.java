...
public class AmigosActivity extends Activity implements OnClickListener,OnItemClickListener{
	private ListView Lista; 
	private ImageButton btn_sueno_a;
	private ImageButton btn_agregar_sueno_a;
	...
	private void init() {
		btn_agregar_sueno_a=(ImageButton) findViewById(R.id.btn_agregar_sueno_a);
		btn_sueno_a=(ImageButton) findViewById(R.id.btn_sueno_a);
		Tittle_List_a=(TextView) findViewById(R.id.Tittle_List_a);
	}
	
	private void addListeners() {
        btn_agregar_sueno_a.setOnClickListener(this);
        btn_sueno_a.setOnClickListener(this);
        Tittle_List_a.setOnClickListener(this);
	}
	
	public void CrearLista(){
		TextView tl = (TextView) findViewById(R.id.Tittle_List_a);
        ...
        for(int i=0; i< gf.size();i++){
         ...
         Lista = (ListView) findViewById(R.id.listAmigosGoal);
         Lista.setAdapter(new Lista_adaptador(this, R.layout.amigos_list, datos){
	...
	public void onClick(View view) {
		if (view.getId() == btn_agregar_sueno_a.getId()){
			Intent i = new Intent(this,NewGoalActivity.class);
			i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(i);
			return;
		}
		if (view.getId() == btn_sueno_a.getId()){
			finish();
			return;
		}
